...
var app = {
   ...
   headerAndFooter: function (event) {
        ...
        jQuery("#" + sId).append('<footer><p>&copy;&nbsp;Copyright ' + new Date().getFullYear() + '&nbsp;Mahmoud Jallala</p></footer>');
    },
    purchase: function(){
        ...
        jQuery("#confirmamount2").html(jQuery("#SalesTax").val());
        jQuery("#confirmamount3").html(jQuery("#total").val());
        jQuery("#confirmamount4").html(jQuery("#tip").val());
        jQuery("#confirmamount5").html(jQuery("#totaltip").val());
        return false;
    },
